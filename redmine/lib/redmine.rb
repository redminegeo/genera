...
Redmine::MenuManager.map :top_menu do |menu|
 # menu.push :home, :home_path, :html => {:class => :init}
 menu.push  :home, :home_path, :html => {:class => :init}
#menu.push :my_page, { :controller => 'my', :action => 'page' }, :if => Proc.new { User.current.logged? }
  menu.push :my_page, { :controller => 'my', :action => 'page' }, :if => Proc.new { User.current.logged? }, :html => {:class => :mypage} 
#menu.push :projects, { :controller => 'projects', :action => 'index' }, :caption => :label_project_plural
  menu.push '  ', { :controller => 'projects', :action => 'index' } , :html => {:class => :depart}
#menu.push :administration, { :controller => 'admin', :action => 'index' }, :if => Proc.new { User.current.admin? }, :last => true
  menu.push :administration, { :controller => 'admin', :action => 'index' }, :if => Proc.new { User.current.admin? }, :last => true , :html => {:class => :adminis}

 # menu.push :help, Redmine::Info.help_url, :last => true
 # menu.push :Datos, Redmine::Info.help_url, :last => true
end
...
Redmine::MenuManager.map :admin_menu do |menu|
  ...
  menu.push :bandeja_compartida, {:controller => 'admin', :action => 'bc_administracion'}, :caption => :label_shared_issues, :last => true
end


Redmine::MenuManager.map :tray_menu do |menu|
 menu.push :new_issue, { :controller => 'issues', :action => 'new', :copy_from => nil }, :param => :project_id, :caption => :label_issue_new
 menu.push :assigned_to_me_issues, { :controller => 'my', :action => 'passig'  },  :html => {:class => :asignadomi}
 menu.push :shared_tray, { :controller => 'my', :action => 'pshare'},  :html => {:class => :compartida}
 menu.push :watched_issues, { :controller => 'my', :action => 'pcopy'  },  :html => {:class => :copia}
 menu.push :reported_issues, { :controller => 'my', :action => 'pmy'  },  :html => {:class => :creadomi}
 menu.push :eraser_issues, { :controller => 'my', :action => 'pdraft'  } ,  :html => {:class => :borrador}
end
