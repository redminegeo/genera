...
Rails.application.routes.draw do
  get 'formal_documents/to_normal', :to => 'formal_documents#to_normal'
  get 'formal_documents/to_signatured', :to => 'formal_documents#to_signatured'
get 'formal_documents/to_normal_trazabilidad', :to => 'formal_documents#to_normal_trazabilidad'

get 'formal_documents/valor', :to => 'formal_documents#valor'
get 'formal_documents/valor_end', :to => 'formal_documents#valor_end'
get 'formal_documents/tipo', :to => 'formal_documents#tipo'
get 'formal_documents/trackers_id', :to => 'formal_documents#trackers_id'
get 'formal_documents/user_id', :to => 'formal_documents#user_id'
match 'formal_documents/to_normal_reporte', :controller => 'formal_documents', :action => 'to_normal_reporte', :via => [:get, :post]


  root :to => 'welcome#index', :as => 'home'

  get 'assigneds/new', :to => 'assigneds#new'
  post 'assigneds', :to => 'assigneds#create'
  post 'assigneds/:id/remove', :to => 'assigneds#remove'
  post 'assigneds/append', :to => 'assigneds#append'
  get 'assigneds/autocomplete_for_assigned', :to => 'assigneds#autocomplete_for_assigned'
  ...
  match 'my/pmy', :controller => 'my', :action => 'pmy', :via => :get
  match 'my/passig', :controller => 'my', :action => 'passig', :via => :get
  match 'my/pcopy', :controller => 'my', :action => 'pcopy', :via => :get
  match 'my/draft', :controller => 'my', :action => 'pdraft', :via => :get
  match 'my/pshare', :controller => 'my', :action => 'pshare', :via => :get
  ...
  match 'admin/bc_administracion', :controller => 'admin', :action => 'bc_administracion', :via => :get
