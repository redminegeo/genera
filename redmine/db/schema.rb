...
ActiveRecord::Schema.define(version: 20180220011702) do
  ...
  add_index "assigneds", ["issue_id"], name: "index_assigneds_on_issue_id", using: :btree
  add_index "assigneds", ["user_id"], name: "index_assigneds_on_user_id", using: :btree
  ...
  create_table "bandeja_compartidas", force: :cascade do |t|
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "usr_propietario_id"
    t.integer  "usr_asistente_id"
  ...
  add_index "easy_entity_assignments", ["entity_from_id"], name: "entity_assignment_idx_from", using: :btree
  add_index "easy_entity_assignments", ["entity_from_type", "entity_from_id", "entity_to_type", "entity_to_id"], name: "entity_assignment_idx", unique: true, using: :btree
  add_index "easy_entity_assignments", ["entity_to_id"], name: "entity_assignment_idx_to", using: :btree
  ...
  add_index "easy_settings", ["name", "project_id"], name: "index_easy_settings_on_name_and_project_id", unique: true, using: :btree
  add_index "easy_settings", ["project_id"], name: "index_easy_settings_on_project_id", using: :btree
  ...
  create_table "formal_documents", force: :cascade do |t|
    t.integer  "issue_id",                      null: false
    t.integer  "journal_id",                    null: false
    t.text     "content_html",                  null: false
    t.string   "filename",                      null: false
    t.integer  "author_id",                     null: false
    t.boolean  "is_signatured", default: false, null: false
  ...
  add_index "formal_documents", ["author_id"], name: "index_formal_documents_on_author_id", using: :btree
  add_index "formal_documents", ["filename"], name: "index_formal_documents_on_filename", using: :btree
  add_index "formal_documents", ["is_signatured"], name: "index_formal_documents_on_is_signatured", using: :btree
  add_index "formal_documents", ["issue_id"], name: "index_formal_documents_on_issue_id", using: :btree
  add_index "formal_documents", ["journal_id"], name: "index_formal_documents_on_journal_id", using: :btree
  ...
  create_table "issues", force: :cascade do |t|
    ...
    t.boolean  "is_deleted",                  default: false
    t.integer  "deleted_user"
    t.string   "project_key",      limit: 10
    t.integer  "issue_number"
    t.integer  "asigner_iduser"
    t.string   "code_num"
  ...
  add_index "issues", ["issue_number"], name: "index_issues_on_issue_number", using: :btree
  ...
  add_index "issues", ["project_key", "issue_number"], name: "index_issues_on_project_key_and_issue_number", using: :btree
  ...
  create_table "moved_issues", force: :cascade do |t|
    t.integer "issue_id"
    t.string  "old_key",    limit: 10
    t.integer "old_number"
  end

  add_index "moved_issues", ["old_key", "old_number"], name: "index_moved_issues_on_old_key_and_old_number", using: :btree
  add_index "moved_issues", ["old_number"], name: "index_moved_issues_on_old_number", using: :btree
  ...
  create_table "project_issue_keys", force: :cascade do |t|
    t.string  "project_key",       limit: 10,             null: false
    t.integer "last_issue_number",            default: 0, null: false
  end

  add_index "project_issue_keys", ["project_key"], name: "index_project_issue_keys_on_project_key", using: :btree
  ...
  add_foreign_key "assigneds", "issues"
  add_foreign_key "assigneds", "users"
  add_foreign_key "easy_settings", "projects"
end
